        ...
        <div className='w-full flex justify-center'>
          <div className='max-w-[1600px] w-full'>
            ...
            <div className='flex flex-row justify-between mx-auto w-[90%] lg:w-[75%] mt-10 lg:mt-[50px] mb-[130px] lg:mb-[180px]'>
              <div 
                className={`flex flex-col lg:flex-row-reverse lg:items-center gap-2 lg:gap-7 cursor-pointer ${!prevPage && 'opacity-50 cursor-default'}`}
                onClick={() => {
                  if (!prevPage) return
              ...
              <div 
                className={`flex flex-col items-end lg:flex-row lg:items-center gap-2 lg:gap-7 cursor-pointer ${!nextPage && 'opacity-50 cursor-default'}`}
                onClick={() => {
                  if (!nextPage) return
