...
export class SearchDialog extends React.Component<{
  ...
  constructor(props: { isOpen: boolean; rootBlockId: string; onClose: () => void; searchNotion: (params: types.SearchParams) => Promise<types.SearchResults> } | Readonly<{ isOpen: boolean; rootBlockId: string; onClose: () => void; searchNotion: (params: types.SearchParams) => Promise<types.SearchResults> }>) {
    super(props)
  ...
  state  : {
    isLoading: boolean
    query: string
    searchResult: types.SearchResults | null
                    ...
                    {searchResult.results.length ? (
                      ...
                      >
                        <div className='resultsPane'>
                          {/* @ts-ignore */}
                          {searchResult.results.map((result: { id: React.Key | null | undefined; page: types.Block; highlight: { html: any } }) => (
                            <components.PageLink
                              key={result.id}
