...
export const AboutExplanation = () => {
    return (
        <div className="flex flex-col justify-center items-center mb-[130px] sm:mb-[40px]">
            ...
            <div className="flex flex-row w-[55%] gap-[72px] mt-[80px] sm:w-[100%] sm:justify-center">
                <p className="text-white text-[15px] leading-[30px] tracking-[-0.165px] font-normal w-[50%] sm:text-center sm:break-keep">
                ...
                <br/><br/><span className="sm:hidden">올해로 6회째를 맞이하는 서울대학교 디자인과 졸업주간, SNU DESIGN WEEK 2023은 학생 디자이너들에게 졸업전시가 가지는 의미를 떠올리는 것에서 출발했습니다. 각자 다양한 삶 속에서 작업을 전개해 온 학생 디자이너들은 졸업주간에 작업으로 그간의 안부를 전하고 인사를 나누려 합니다. 저마다의 경험과 배움을 응축한 수많은 작업들이 한 때 한 곳에 모였을 때 만들어지는 여러 마주침의 역동적인 에너지는 졸업주간 행사를 통해 세상으로 뻗어나갈 것입니다. 이처럼 적극적이고 두려움 없이 세상과 부딪혀 나갈 디자이너들의 졸업주간 행사는 서울대학교 49동 디자인연구동과 웹사이트에서 함께 진행됩니다. 이번 12월엔 SNU DESIGN WEEK 2023에서 42명의 학생 디자이너들이 만들어내는 충돌의 열기를 느껴보시길 바랍니다.</span>
                </p>
