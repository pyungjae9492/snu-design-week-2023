// TODOsean: 참여자들 간 gap 관련 수정 (절대값 48px로 설정?)
...
export const ExhibitionParticipants = () => {
    ...
    return (
        <div className="flex flex-col mt-[96px] sm:mt-[60px]">
            ...
            <div className="flex flex-wrap gap-[48px] mb-[233px]">
                {participants.map((participant, index) => (
                    <div key={index} className="flex flex-row items-center gap-[7px] ml-[2px] sm:gap-[3.06px]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8" fill="none">
                            <circle cx="4" cy="4" r="4" fill="white"/>
                        </svg>
                        <p className="text-[15px] font-normal leading-[30px] tracking-[-0.165px] sm:text-[14px] sm:leading-[28px] sm:tracking-[-0.154px] sm:font-medium">{participant}</p>
                    </div>
                ))}
            </div>
        </div>
