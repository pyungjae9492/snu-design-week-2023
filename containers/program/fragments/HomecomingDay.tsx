const homecomingDayDetails = "일정 | 12.01 (토) 19:00 - 20:00 \n장소 | 서울대학교 49동\n대상 | 서울대학교 디자인과 동문 및 재학생\n\n하이데이는 온라인 전시 오픈 전, 디자인 동문 선배님들을 모시고 졸업생들의 작품을 소개하고 오프라인 전시 모습을 함께 감상하며 이야기를 나누는 자리입니다. 졸업생들의 졸업작품을 매개로 선후배 간 소통의 장을 열고, 전시의 리뷰를 함께 나누는 순간을 가지며 졸업주간을 마무리하는 서울대학교 디자인과 동문의 교류 행사입니다."
