...
const workshopSchedule2 = "DAY 2. 시아노타입 워크숍\n일정 | 12. 01 (금) 14:00\n진행 | 김재현\n김재현 학생디자이너는 실험적인 그래픽 프로세스를 탐구하는 디자이너입니다. 시아노타입이란 화학적 혼합액을 종이 혹은 천에 바른 뒤 햇볕 등의 자외선을 쪼여 지면에 형태를 만들어내는 기법을 말합니다. 청사진기법으로도 잘 알려진 이 기법을 통해 프러시안 블루의 깊고 오묘한 색감과 선명한 백색이 조화를 이루는 이미지를 만들어볼 수 있습니다."
const workshopSchedule4 = "DAY 4. 포트폴리오 리뷰\n일정 | 12.03 (일) 17:30\n진행 |  pxd\n‘실패로부터 배우고 지식을 공유하여 모두의 경험을 확장합니다.’라는 모토를 가진 UX 디자인 그룹 pxd에서 포트폴리오 전략에 도움이 될만한 정보를 전달해주시는 시간입니다. 1부에서는 pxd가 입사 지원자의 포트폴리오를 볼 때의 관점을 공유하며, 포트폴리오에 대한 기본적인 내용을 소개합니다. 2부에서는 신청자의 포트폴리오를 받아 리뷰하는 시간을 가집니다. 오랜 기간 다양한 성격의 기업과 협업하며 다채로운 디바이스의 UX를 설계한 pxd는 올 해의 포트폴리오 리뷰 시간을 더욱 가치있는 자리로 만들어 주실 것입니다."
const workshopSchedule5 = "DAY 5. ID, VD 인턴 토크\n일정 | 12. 04 (월) 18:00\n진행 | 김가은, 송채은, 임유리\n재학 중 기업에서 인턴을 하며 겪었던 경험과 생각들을 함께 나누고 공유하는 토크 워크숍입니다. 인턴 생활의 궁금했던 점들을 부담없이 물어보고 이야기를 나눌 수 있습니다."
